...
###########################################################################################
##### USAGE: Rscript extract_betas_from_GSE74432_clocks.R probes_path probes_name     #####
###########################################################################################
...
input_path <- "/nfs/nobackup/thornton/dem44/methylation_clock/polycomb_hypothesis/epigenetic_syndromes/GSE74432/beta_values/"; # Path where all the beta-values matrices are located
output_path <- "/nfs/nobackup/thornton/dem44/methylation_clock/polycomb_hypothesis/epigenetic_syndromes/GSE74432/additional_analyses/";
metadata_path <- "/nfs/nobackup/thornton/dem44/methylation_clock/polycomb_hypothesis/epigenetic_syndromes/GSE74432/additional_analyses/cases_data_downstream_GSE74432.tsv";
...
print(paste0('There are ', nrow(final_metadata), ' cases samples in the original metadata.'));
