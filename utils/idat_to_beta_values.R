...
###########################################################################################
##### Calculate the beta-values matrix (rows:probes, columns:samples) given the IDAT   ####
##### files in a folder. The NFB (noob+filtering+BMIQ) preprocessing strategy will be  ####
...
###########################################################################################
##### USAGE: Rscript idat_to_beta_values.R path/to/idats /path/to/output /path/to/annotation
...
#####       path/to/annotation: absolute path to the folder which contains the cross-reactive probes file.
###########################################################################################
...
#path_to_raw_idat <- "/Users/dem44/Desktop/methylation_clock/polycomb_hypothesis/epigenetic_syndromes/differential_methylation/raw_data_control/";
...
output_path <- args[2];
#ann_path <- '/Users/dem44/Desktop/methylation_clock/polycomb_hypothesis/epigenetic_syndromes/differential_methylation/'
ann_path <- args[3];
